  ...
  if (showSplash) {
    return (
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #0B1A33 0%, #1A3A6B 50%, #2563EB 100%)',
      ...
      >
        ...
        <div
          className="relative"
          style={{ animation: 'fadeInScale 1.5s ease-out forwards, pulseGlow 3s ease-in-out infinite' }}
        >
          <Image
            src="/images/logo.png"
            alt="Labusel"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
          <div data-aos="fade-up" data-aos-duration="1000">
            ...
            <p className="mt-6 text-lg text-gray-200 max-w-2xl mx-auto">
              Efisiensi, transparansi, dan responsivitas dalam satu ekosistem digital untuk Bupati, dinas, dan masyarakat.
            </p>
          </div>
          <div
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="mt-2 text-gray-600">
                Bupati mengirim pengumuman ke seluruh dinas atau target tertentu secara instan.
              </p>
            </div>
            {/* Card 2 */}
            <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Alur informasi dari Bupati hingga masyarakat menjadi lebih singkat.
              </p>
            </div>
            {/* Value 3 */}
